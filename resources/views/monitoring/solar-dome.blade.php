...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-lg border-0 rounded-3 mb-4">
        ...
        <p class="mb-0 small text-light text-start">Local Control System</p>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-center align-items-center gap-2">
                <input type="number" class="form-control w-auto" id="targetHumidity" placeholder="Target Kelembapan (%)">
